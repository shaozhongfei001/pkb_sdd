...
class KbFileInstance(Base):
    ...
    is_available: Mapped[int] = mapped_column(SmallInteger, nullable=False, default=1)
    is_duplicate_instance: Mapped[int] = mapped_column(SmallInteger, nullable=False, default=0)
