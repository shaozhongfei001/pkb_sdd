...
### 9.5 013-streamlit-admin（ACTIVE / NOT IMPLEMENTED）

只读 Streamlit 管理台（无 parser、无 pipeline 触发、无 DB 写入 MVP）：

- 页面（MVP）：KB Search、Evidence Explorer、Projects & Curated、Parse Registry、Quality Reports；（可选）Inventory Snapshot
